    ...
    return (
        <IonGrid>
            <Card style={{ width: '100%' }}>
                <Card.Body>
                    <Card.Title className="card-title">LEMBRETE</Card.Title>
                    <Card.Text>
                        <IonRow>
                            ...
                            <IonCol size="4">
                                <IonList>
                                    <IonItem>
                                        ...
                                        <IonSelect value={days} okText="Ok" cancelText="Cancelar" onIonChange={e => setDays(e.detail.value)}>
                            ...
                            <IonCol size="4">
                                <IonList>
                                    <IonItem>
                                        ...
                                        <IonSelect value={hours} okText="Ok" cancelText="Cancelar" onIonChange={e => setHours(e.detail.value)}>
                                        <IonSelectOption value='0'>0</IonSelectOption>
                                            <IonSelectOption value='1'>1</IonSelectOption>
                                            <IonSelectOption value='2'>2</IonSelectOption>
                                            <IonSelectOption value='3'>3</IonSelectOption>
                            ...
                            <IonCol size="4">
                                <IonList>
                                    <IonItem>
                                        ...
                                        <IonSelect value={minutes} okText="Ok" cancelText="Cancelar" onIonChange={e => setMinutes(e.detail.value)}>
                                        <IonSelectOption value='0'>0</IonSelectOption>
                                            <IonSelectOption value='5'>5</IonSelectOption>
                                            <IonSelectOption value='10'>10</IonSelectOption>
                                            <IonSelectOption value='15'>15</IonSelectOption>
