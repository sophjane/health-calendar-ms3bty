...
const CreateAccount: React.FC<RouteComponentProps> = ({ history }) => {
  ...
  return (
    <IonPage>
      <IonHeader>
        <Toolbar variant="back" title="Criar Conta"></Toolbar>
      </IonHeader>
      <IonContent fullscreen>
        <IonGrid>
          <IonRow className="d-flex justify-content-center mt-5 mb-3">
            ...
            <img
              className="mx-3"
              src={process.env.PUBLIC_URL + "/favicon2.png"}
          ...
          <IonRow className="d-flex flex-column mt-3 mb-3">
            <IonItem>
              ...
              <IonInput placeholder="Nome Completo" type="text" clearInput>
                {" "}
              </IonInput>
            </IonItem>
            <IonItem>
              <IonLabel position="stacked"> Email</IonLabel>
              <IonInput placeholder="Email" type="email" clearInput>
                {" "}
              </IonInput>
            </IonItem>
            <IonItem>
            ...
            <IonItem>
              ...
              <IonInput placeholder="123456789" type="email" clearInput>
                {" "}
              </IonInput>
            </IonItem>
          </IonRow>
